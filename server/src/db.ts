...
export const gameIds = ['demo', 'stick', 'pong', 'snake', 'gyro', 'accel'] as const
...
const API_DEMO = await admin.ensureUser('api-demo', false, true, 'readonly')
const API_OMED = await admin.ensureUser('api-omed', false, true, 'writeonly')
export const RASPI = await admin.ensureUser('raspi', null, true, '94de889064a147c3a960d289356858dc6a384b2a90c04f078a47bd87ddef7137')
...
await admin.ensureAccess('public', SERVER, EVERYONE, API_OMED, USERS)
await admin.ensureAccess('controls', SERVER, API_DEMO, API_OMED, USERS)
await admin.ensureAccess('private', SERVER, API_DEMO, API_OMED, false)
await admin.destroy()
